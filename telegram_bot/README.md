Telegram bot sends security alerts from Wazuh SIEM to Telegram. It filters and forwards alerts based on severity levels, only medium (7) and high (10) severity alerts from Suricata.
